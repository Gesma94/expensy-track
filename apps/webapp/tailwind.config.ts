    ...
    colors: {
      ...
      background: {
        ...
        secondary: {
          ...
          hover: 'rgba(33, 150, 243, 0.20)', // Slightly more opaque blue for hover
          selected: 'rgba(33, 150, 243, 0.24)', // More pronounced blue for selected state
          'selected-hover': 'rgba(33, 150, 243, 0.29)', // Noticeable blue for selected + hover
          active: 'rgba(33, 150, 243, 0.33)', // Even stronger blue for active state
